...
function generatePromptSection(prompt: Prompt, index: number, locale: string): string {
  ...
  md += `**[${t('tryItNow', locale)}](https://youmind.com/gemini-3-prompts?prompt=${encodedPrompt})**\n\n`;
...
function generateAllPromptsSection(regular: Prompt[], hiddenCount: number, locale: string): string {
  ...
  if (hiddenCount > 0) {
    ...
    md += `**[${t('viewAll', locale)}](https://youmind.com/gemini-3-prompts)**\n\n`;
...
- [🤔 ${t('whatIs', locale)}](#-what-is-gemini-3)
...
1. Click [**${t('submitNewPrompt', locale)}**](https://github.com/YouMind-OpenLab/awesome-gemini-3-prompts/issues/new?template=submit-prompt.yml)
2. ${t('fillForm', locale)}
...
**[🌐 ${t('viewInGallery', locale)}](https://youmind.com/gemini-3-prompts)** •
**[📝 ${t('submitPrompt', locale)}](https://github.com/YouMind-OpenLab/awesome-gemini-3-prompts/issues/new?template=submit-prompt.yml)** •
**[⭐ ${t('starRepo', locale)}](https://github.com/YouMind-OpenLab/awesome-gemini-3-prompts)**
